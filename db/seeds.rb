...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly",
                                subtitle: "Ongoing Course", author: "Mattan Griffel", author_image_name: "teacher-image.jpg", details: "We'll charge you monthly for unlimited access.",
                                download_url: "https://s3.amazonaws.com/srg-one-month-stripe-payments/placeholder.txt",
                                price: "4.99", length: "6 months", sku: "GROHACK2", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
copywriting_monthly = Product.create(title: "Copywriting Monthly",
                                        subtitle: "Ongoing Course", author: "Mattan Griffel", author_image_name: "teacher-image.jpg", details: "We'll charge you monthly for unlimited access.",
                                        download_url: "https://s3.amazonaws.com/srg-one-month-stripe-payments/placeholder.txt",
                                        price: "4.99", length: "6 months", sku: "ANALYTICS2", description: %{<p>A copywriter is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
analytics_monthly = Product.create(title: "Analytics Monthly",
                                     subtitle: "Ongoing Course", author: "Mattan Griffel", author_image_name: "teacher-image.jpg", details: "We'll charge you monthly for unlimited access.",
                                     download_url: "https://s3.amazonaws.com/srg-one-month-stripe-payments/placeholder.txt",
                                     price: "4.99", length: "6 months", sku: "COPYWRITE2", description: %{<p>A copywriter is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
 <p>In this series, Mattan Griffel introduces you to the concept of Copywriting and shares his favorite tips for getting started as a copywriter.</p>
 <p><strong>What You'll Learn</strong></p>
 <ul class="no-indent">
